...
type mockQueryer struct {
	...
	load  func(vu *VU, batch Batch, args [][]any) ([]map[string]any, time.Duration, error)
}
...
func (m *mockQueryer) Load(vu *VU, batch Batch, args [][]any) ([]map[string]any, time.Duration, error) {
